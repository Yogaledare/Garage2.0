    ...
    public static void Seed(IApplicationBuilder applicationBuilder)
    {
        ...
        for (int i = 0; i < 50; i++)
        {
            ...
            if (random.Next(100) < 75) // 75% chance to have a departure time
            {
                ...
                if (departureTime >= DateTime.Now) departureTime = null; // Ensure departure is in the past
            }
            else
            {
                departureTime = null;
            ...
            {
                LicensePlate = $"{(char)('A' + random.Next(0, 26))}{(char)('A' + random.Next(0, 26))}{(char)('A' + random.Next(0, 26))}{random.Next(100, 999)}",
                ...
                ParkingSpot = new ParkingSpot(i + 1, false) // Assuming you have a mechanism to handle parking spots
            });
        }
